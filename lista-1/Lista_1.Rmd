...
```
Como a probabilidade de uma palavra do dicionário é baixa, vou gerar amostras que crescem em "blocos" de mil em mil. Vamos gerar duzentas amostras e calcular a probabilidade de as palavras serem válidas: 
